...
export default function SettingsPage() {
  ...
  return <AppShell active="/settings" session={{ kind: "user", user }}><div className="mx-auto max-w-[1080px] pb-14">
    ...
    <nav className="mt-6 flex gap-2 overflow-x-auto pb-1"><span className="rounded-xl border border-teal-700 bg-teal-100 px-4 py-2 text-[11px] font-semibold text-teal-800">General</span><Link href="/notifications" className="rounded-xl border border-line bg-white px-4 py-2 text-[11px] font-semibold">Notifications</Link><Link href="/profile" className="rounded-xl border border-line bg-white px-4 py-2 text-[11px] font-semibold">Privacy & safety</Link></nav>
    {!preferences ? <PageLoading /> : <div className="mt-4 space-y-4">
      <section className="overflow-hidden rounded-2xl border border-line bg-white shadow-sm"><h2 className="px-5 pt-4 text-sm font-bold">General preferences {saving && <span className="ml-2 text-[9px] font-normal text-ink-soft">Saving…</span>}</h2>
      ...
      <section className="overflow-hidden rounded-2xl border border-line bg-white shadow-sm"><h2 className="px-5 pt-4 text-sm font-bold">Accessibility</h2>
