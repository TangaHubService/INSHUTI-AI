...
type Copy = {
  nav: { chat: string; mySpace: string; appointments: string; findCare: string; library: string; about: string };
  hero: { eyebrow: string; titleLead: string; titleEm: string; body: string; ctaChat: string; ctaBrowse: string; trustSignup: string; trustReviewed: string; trustBilingual: string };
...
const COPY: Record<Language, Copy> = {
  EN: {
    nav: { chat: "Chat", mySpace: "My Space", appointments: "Appointments", findCare: "Find Care", library: "Library", about: "About" },
    hero: { eyebrow: "Free · Anonymous · Bilingual", titleLead: "Ask anything about your health. ", titleEm: "Get a friend's answer.", body: "Inshuti is an AI assistant that gives young people honest, judgment-free answers on sexual and reproductive health — reviewed by professionals, available anytime, in English or Kinyarwanda.", ctaChat: "Chat with Inshuti", ctaBrowse: "Browse topics", trustSignup: "No sign-up required", trustReviewed: "Reviewed by clinicians", trustBilingual: "English & Kinyarwanda" },
    demo: { name: "Inshuti Assistant", session: "Anonymous session", question: "Can I become pregnant during my period?", answer: "Pregnancy is less likely during menstruation, but still possible depending on the timing of ovulation. If you're concerned, a pregnancy test can help — and it's always okay to speak with a health worker.", chip1: "How ovulation works", chip2: "Find a clinic near me" },
    topics: { eyebrow: "Popular topics", title: "Wherever you're starting from", body: "Six areas young people ask about most — tap one to jump straight into a conversation.", cta: "Ask about this", items: [
    ...
    features: { eyebrow: "Why Inshuti", title: "Built to be trusted", items: [
    ...
    preview: { eyebrow: "See it in action", title: "Chat preview", question: "Can I become pregnant during my period?", answer: "Pregnancy is less likely during menstruation, but it is still possible depending on the timing of ovulation. If you have concerns about pregnancy, consider taking a pregnancy test and consult a healthcare provider." },
  ...
  RW: {
    nav: { chat: "Ganira", mySpace: "Umwanya wanjye", appointments: "Gahunda", findCare: "Shaka Ubuvuzi", library: "Ububiko", about: "Ibyerekeye" },
    hero: { eyebrow: "Ku buntu · Wihishe · Indimi ebyiri", titleLead: "Baza ikibazo icyo aricyo cyose ku buzima bwawe. ", titleEm: "Bonera igisubizo nk'icy'inshuti.", body: "Inshuti ni umufasha wa AI utanga ibisubizo by'ukuri, bitagira urubanza, ku ngingo z'ubuzima bw'imyororokere ku rubyiruko — birebwa n'abaganga, biboneka igihe cyose, mu Cyongereza cyangwa mu Kinyarwanda.", ctaChat: "Ganira na Inshuti", ctaBrowse: "Reba insanganyamatsiko", trustSignup: "Ntibisaba kwiyandikisha", trustReviewed: "Birebwa n'abaganga", trustBilingual: "Icyongereza & Ikinyarwanda" },
    demo: { name: "Umufasha wa Inshuti", session: "Umukoro wihishe", question: "Ese nshobora gutwita nkiri mu mihango?", answer: "Gutwita birakunda kudindiza mu gihe cy'imihango, ariko birashoboka bitewe n'igihe cy'ubwororoke. Niba ufite impungenge, ikizamini cyo gutwita gishobora gufasha — kandi ntakibazo kuvugana n'umukozi w'ubuzima.", chip1: "Uko ubwororoke bukora", chip2: "Shaka ivuriro riri hafi" },
    topics: { eyebrow: "Insanganyamatsiko zikunzwe", title: "Uvuye aho uri hose", body: "Ibice bitandatu urubyiruko rukunze kubaza — kandaho kimwe ubone ikiganiro ako kanya.", cta: "Baza kuri iki", items: [
    ...
    features: { eyebrow: "Impamvu Inshuti", title: "Yubatswe kugira ngo yiziherwe", items: [
    ...
    preview: { eyebrow: "Reba uko bikora", title: "Urugero rw'ikiganiro", question: "Ese nshobora gutwita nkiri mu mihango?", answer: "Gutwita birakunda kudindiza mu gihe cy'imihango, ariko birashoboka bitewe n'igihe cy'ubwororoke. Niba ufite impungenge ku gutwita, gerageza ikizamini cyo gutwita kandi ubaze umukozi w'ubuzima." },
  ...
  FR: {
    nav: { chat: "Discuter", mySpace: "Mon Espace", appointments: "Rendez-vous", findCare: "Trouver des Soins", library: "Bibliothèque", about: "À propos" },
    hero: { eyebrow: "Gratuit · Anonyme · Bilingue", titleLead: "Posez toutes vos questions de santé. ", titleEm: "Obtenez la réponse d'un ami.", body: "Inshuti est un assistant IA qui donne aux jeunes des réponses honnêtes et sans jugement sur la santé sexuelle et reproductive — validées par des professionnels, disponibles à tout moment, en anglais ou en kinyarwanda.", ctaChat: "Discuter avec Inshuti", ctaBrowse: "Parcourir les sujets", trustSignup: "Aucune inscription requise", trustReviewed: "Validé par des cliniciens", trustBilingual: "Anglais & Kinyarwanda" },
    demo: { name: "Assistant Inshuti", session: "Session anonyme", question: "Puis-je tomber enceinte pendant mes règles ?", answer: "Une grossesse est moins probable pendant les règles, mais reste possible selon le moment de l'ovulation. En cas de doute, un test de grossesse peut aider — et il est toujours possible d'en parler à un professionnel de santé.", chip1: "Comment fonctionne l'ovulation", chip2: "Trouver une clinique proche" },
    topics: { eyebrow: "Sujets populaires", title: "Où que vous en soyez", body: "Six thèmes les plus demandés par les jeunes — cliquez pour démarrer une conversation.", cta: "Poser une question", items: [
    ...
    features: { eyebrow: "Pourquoi Inshuti", title: "Conçu pour être fiable", items: [
    ...
    preview: { eyebrow: "Voir en action", title: "Aperçu de la discussion", question: "Puis-je tomber enceinte pendant mes règles ?", answer: "Une grossesse est moins probable pendant les règles, mais reste possible selon le moment de l'ovulation. En cas d'inquiétude, envisagez un test de grossesse et consultez un professionnel de santé." },
  ...
  SW: {
    nav: { chat: "Ongea", mySpace: "Nafasi Yangu", appointments: "Miadi", findCare: "Tafuta Huduma", library: "Maktaba", about: "Kuhusu" },
    hero: { eyebrow: "Bure · Bila Jina · Lugha Mbili", titleLead: "Uliza chochote kuhusu afya yako. ", titleEm: "Pata jibu la rafiki.", body: "Inshuti ni msaidizi wa AI unaowapa vijana majibu ya kweli, yasiyo na hukumu kuhusu afya ya uzazi na ngono — yaliyopitiwa na wataalamu, yanapatikana wakati wowote, kwa Kiingereza au Kinyarwanda.", ctaChat: "Ongea na Inshuti", ctaBrowse: "Vinjari mada", trustSignup: "Hakuna usajili unaohitajika", trustReviewed: "Imepitiwa na madaktari", trustBilingual: "Kiingereza & Kinyarwanda" },
    demo: { name: "Msaidizi wa Inshuti", session: "Kipindi bila jina", question: "Je, ninaweza kupata mimba nikiwa kwenye hedhi?", answer: "Uwezekano wa kupata mimba ni mdogo wakati wa hedhi, lakini bado inawezekana kutegemea wakati wa udondoshaji wa yai. Ukiwa na wasiwasi, kipimo cha ujauzito kinaweza kusaidia — na ni sawa kuzungumza na mhudumu wa afya.", chip1: "Jinsi udondoshaji wa yai unavyofanya kazi", chip2: "Tafuta kliniki iliyo karibu" },
    topics: { eyebrow: "Mada Maarufu", title: "Popote unapoanzia", body: "Maeneo sita ambayo vijana huuliza zaidi — gusa moja kuanza mazungumzo moja kwa moja.", cta: "Uliza kuhusu hili", items: [
    ...
    features: { eyebrow: "Kwa Nini Inshuti", title: "Imejengwa kuaminika", items: [
    ...
    preview: { eyebrow: "Ona ikifanya kazi", title: "Muhtasari wa Mazungumzo", question: "Je, ninaweza kupata mimba nikiwa kwenye hedhi?", answer: "Uwezekano wa kupata mimba ni mdogo wakati wa hedhi, lakini bado inawezekana kutegemea wakati wa udondoshaji wa yai. Ukiwa na wasiwasi kuhusu ujauzito, fikiria kupima ujauzito na kumuona mtaalamu wa afya." },
...
export default function Home() {
  ...
  return (
    ...
    >
      <section className="animate-slide-up grid grid-cols-1 items-center gap-14 py-[76px] md:grid-cols-[1.05fr_0.95fr]">
        <div>
          ...
          <div className="mt-8 flex flex-wrap gap-[14px]">
            <Link
              href="/chat"
              className="inline-flex items-center justify-center gap-2 rounded-full bg-coral px-[26px] py-[13px] text-[15px] font-semibold text-white shadow-[0_8px_20px_rgba(232,115,92,0.35)] transition-all duration-150 hover:-translate-y-px hover:bg-coral-dark"
            >
              {t.hero.ctaChat}
            ...
            <a
              href="#topics"
              className="inline-flex items-center justify-center gap-2 rounded-full border-[1.5px] border-teal-700 px-[26px] py-[13px] text-[15px] font-semibold text-teal-700 transition-all duration-150 hover:-translate-y-px hover:bg-teal-100"
            >
              {t.hero.ctaBrowse}
            </a>
          </div>
          <div className="mt-10 flex flex-wrap gap-[22px]">
            <div className="flex items-center gap-2 text-[13.5px] font-semibold text-ink-soft">
              <svg width="16" height="16" className="text-teal-700"><use href="#i-lock" /></svg>
              {t.hero.trustSignup}
            </div>
            <div className="flex items-center gap-2 text-[13.5px] font-semibold text-ink-soft">
              <svg width="16" height="16" className="text-teal-700"><use href="#i-book" /></svg>
              {t.hero.trustReviewed}
            </div>
            <div className="flex items-center gap-2 text-[13.5px] font-semibold text-ink-soft">
              <svg width="16" height="16" className="text-teal-700"><use href="#i-globe" /></svg>
        ...
        <div className="relative">
          <svg className="absolute -right-5 -top-10 z-0 w-[340px] opacity-50" viewBox="0 0 64 64"><use href="#mark-knot" /></svg>
          <div className="relative z-10 rounded-[32px] border border-line bg-white p-5 shadow-soft">
            <div className="flex items-center gap-2.5 border-b border-line pb-[14px]">
              <div className="flex h-[34px] w-[34px] items-center justify-center rounded-full bg-teal-700">
                <svg width="18" height="18" className="text-white"><use href="#i-bot" /></svg>
              </div>
              <div>
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              <span className="rounded-full border border-line bg-white px-[13px] py-[7px] text-[12.5px] font-semibold text-teal-700">{t.demo.chip1}</span>
              <span className="rounded-full border border-line bg-white px-[13px] py-[7px] text-[12.5px] font-semibold text-teal-700">{t.demo.chip2}</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16" id="topics">
        <div className="mx-auto mb-10 max-w-[560px] text-center">
          <span className="block font-mono text-[12.5px] font-medium uppercase tracking-[0.12em] text-coral-dark">{t.topics.eyebrow}</span>
      ...
      <section className="py-16">
        <div className="mx-auto mb-10 max-w-[560px] text-center">
          <span className="block font-mono text-[12.5px] font-medium uppercase tracking-[0.12em] text-coral-dark">{t.features.eyebrow}</span>
        ...
        <div className="grid grid-cols-1 gap-[18px] sm:grid-cols-2 lg:grid-cols-4">
          {t.features.items.map((feature) => (
            <div
              key={feature.title}
              className="rounded-md border border-[rgba(22,48,44,0.05)] bg-white p-6 text-left shadow-card transition-all duration-150 hover:-translate-y-1 hover:shadow-soft"
            >
      ...
      <section className="mx-auto max-w-[760px] pb-16">
        <div className="mx-auto mb-10 max-w-[560px] text-center">
          <span className="block font-mono text-[12.5px] font-medium uppercase tracking-[0.12em] text-coral-dark">{t.preview.eyebrow}</span>
